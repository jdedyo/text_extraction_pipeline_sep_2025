...
# bash download_and_process_pdfs_range.sh NB_CPUS MIN_YEAR MAX_YEAR
# NB_CPUS can be e.g. 200 or more
# e.g. bash process_pdfs_range.sh 200 2010 2015
...
do
    ...
    bash download_and_process_pdfs_one_year.sh "$cpus" "$y"
done